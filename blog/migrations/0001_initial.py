    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downvote', models.ManyToManyField(blank=True, related_name='down', to=settings.AUTH_USER_MODEL, verbose_name='Дизлайки')),
                ...
                ('upvote', models.ManyToManyField(blank=True, related_name='up', to=settings.AUTH_USER_MODEL, verbose_name='Лайки')),
            ],
            options={
                'verbose_name': 'Статья',
